...
PVE::Mounts - Parser for Linux /proc/mounts

=head1 SYNOPSIS

  use PVE::Mounts;

  my $m = PVE::Mounts->read;
...
=item $mnts = PVE::Mounts->read

=item $mnts = PVE::Mounts->read(%opts)
...
=head2 The PVE::Mounts::Entry class
...
L<PVE::Mountinfo>. The information offered by the Linux kernel
through C</proc/$pid/mountinfo> is more detailed so you should
probably use that module instead of PVE::Mounts.
